...
model = ConcreteModel()
model.logAf = Var(within=PositiveReals, bounds=(10, 100), initialize = 32)  #1,8e14
model.logAs = Var(within=PositiveReals, bounds=(10, 100), initialize = 32)  #2.3e11
model.logAd = Var(within=PositiveReals, bounds=(10, 100), initialize = 32)  #1.4e14
model.logAo = Var(within=PositiveReals, bounds=(10, 100), initialize = 32)  #1.4e14
...
for s in Sample:
    if np.any(CA_meas[s]==0):
        ...
        print('There are acid datapoints in the training set')
...
for s in Sample_test:
    if np.any(CA_test[s]==0):
        ...
        print('There are acid datapoints in the test set')
