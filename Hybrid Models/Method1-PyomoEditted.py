...
for i in range(len(CA_set)):
    ...
    N_sample = len(Xf_set)  # Can possibly get rid of this
    Sample = range(N_sample) # Can possibly get rid of this
    ...
    model = ConcreteModel()
#     model.logAh = Var(within=PositiveReals, bounds=(1, 500), initialize = 32)  #1,8e14
#     model.logAd = Var(within=PositiveReals, bounds=(1, 500), initialize = 32)  #1.4e14
#     model.Eh = Var(within=PositiveReals, bounds=(100, 1e10), initialize = 1e5)     #1.4e5
#     model.Ed = Var(within=PositiveReals, bounds=(100, 1e10), initialize = 1e5)     #1.4e5
#     model.logAh_CA = Var(within=PositiveReals, bounds=(1, 500), initialize = 32)  #1,8e14
#     model.logAd_CA = Var(within=PositiveReals, bounds=(1, 500), initialize = 32)  #1.4e14
#     model.Eh_CA = Var(within=PositiveReals, bounds=(100, 1e10), initialize = 1e5)     #1.4e5
#     model.Ed_CA = Var(within=PositiveReals, bounds=(100, 1e10), initialize = 1e5)     #1.4e5   
#     model.mh_CA = Var(within=PositiveReals, bounds=(0.1,10), initialize = 1)         #5.5
#     model.md_CA = Var(within=PositiveReals, bounds=(0.1,10), initialize = 1)         #1.3
    
#     model.Ah = Var(within=PositiveReals, initialize = 1.8e14)  #1,8e14
#     model.Ad = Var(within=PositiveReals, initialize = 1.8e14)  #1.4e14
#     model.Eh = Var(within=PositiveReals, initialize = 150)     #1.4e5
#     model.Ed = Var(within=PositiveReals, initialize = 150)     #1.4e5
#     model.Ah_CA = Var(within=PositiveReals, initialize = 1.8e14)  #1,8e14
#     model.Ad_CA = Var(within=PositiveReals, initialize = 1.8e14)  #1.4e14
#     model.Eh_CA = Var(within=PositiveReals, initialize = 150)     #1.4e5
#     model.Ed_CA = Var(within=PositiveReals, initialize = 150)     #1.4e5   
#     model.mh_CA = Var(within=PositiveReals,bounds=(0.1,10), initialize = 1.75)         #5.5
#     model.md_CA = Var(within=PositiveReals,bounds=(0.1,10), initialize = 1)         #1.3
    
     
    model.Ah = Var(within=PositiveReals, bounds=(1e8, 1e30))  #1,8e14
    model.Ad = Var(within=PositiveReals, bounds=(1e8, 1e30))  #1.4e14
    model.Eh = Var(within=PositiveReals, bounds=(50, 300))     #1.4e5
    model.Ed = Var(within=PositiveReals, bounds=(50, 300))     #1.4e5
    model.Ah_CA = Var(within=PositiveReals, bounds=(1e8, 1e30))  #1,8e14
    model.Ad_CA = Var(within=PositiveReals, bounds=(1e8, 1e30))  #1.4e14
    model.Eh_CA = Var(within=PositiveReals, bounds=(50, 300))     #1.4e5
    model.Ed_CA = Var(within=PositiveReals, bounds=(50, 300))     #1.4e5   
    model.mh_CA = Var(within=PositiveReals,bounds=(0.1,1))         #5.5
    model.md_CA = Var(within=PositiveReals,bounds=(0.1,3))         #1.3
    
    
    model.kh = Var(Sample, within=PositiveReals,bounds=(1e-20,1e30), initialize=1)         #1e-9
